# The English Check — the blueprint

_The specification both papers are written against. Companion to `ENGLISH-ASSESSMENT-PLAN.md`.
Form A and Form B differ only in the content that fills each numbered task._

## The shape

**One paper. Everyone sits all of it.** There is no routing, no separate booklets, no thresholds to
work out on the day. A learner who cannot do a task leaves it blank and moves on; blanks are data,
not failure. Tasks run easiest-first, so a learner meets what they can do before they meet what they
cannot.
...
Four, and nothing between them: **Pre-A1 · A1 · A2 · B1**. Each part gives its own level. They are
never combined into one — a learner is routinely a level higher in speaking than in writing, and
...
Five prompts — personal information, a picture, three simple questions, an extended turn, and a warm
close — scored on four strands of 0–4: **intelligibility · range · interaction · extended turn**.
Confidence is noted but not scored.
...
**Vocabulary.** A1 and A2 tasks draw on the first ~1,500 word families plus what the component
teaches. The B1 text may reach to ~2,500.

**Domains.** Block and shelter life, water, the health post, the learning centre and its timetable,
weather and the hills, small work and volunteering, family and neighbours, training and forms.

**Excluded, without exception:** repatriation, violence, fire, loss of family, boat journeys, camp
politics, grievances about aid. "I am from ___" is never a required answer, because the component's
own materials flag that it can touch displacement and separation. Every writing and speaking prompt
...
## The parallel-form check

Run before either form is printed. Form B is rewritten if any line fails.
